...
const isUserExistIntoDB = (email) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.User.findOne({ email });
    return result;
});
const createUserIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const Password = (0, passwordHelper_1.hashPassword)(payload.password);
...
const deleteUserFromDB = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.User.findOneAndDelete({ _id });
    return result;
});
const updateUserOnDb = (_id, payload) => __awaiter(void 0, void 0, void 0, function* () {
